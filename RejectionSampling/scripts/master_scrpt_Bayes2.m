%Problem 2: Predict that Sprinkler is on given grass is wet 
% The Simple Bayes Net 2 has the form: cloudy->Rain; Rain->Sprinkler,wetgrass, Sprinkler,Rain -> Wetgrass 
...
% as: P(C,S,R,W)= P(W|S,R,C). P(S|R).P(R|C).P(C)
...
CPT_sprinkler=[0.5 0.5; 0.95 0.05];
